...
const Content = () => {
    const experiences = [
        {
          schoolName: 'MTS School',
          type: 'Full Time',
          startDate: 'JULY 2018',
          location: 'Sawai Madhopur, India',
          description: 'As a School Online Systems Manager at MTS School Sawai Madhopur, I played a pivotal role  managing and optimizing the school\'s online systems with a specialization in RTE (Right to Education)  BSER (Board of Secondary Education). During my tenure, I successfully oversaw and streamlined all of student information management, ensuring efficient processes from admission forms to mark sheets.',
        },
        {
          schoolName: 'Bright Sun Sikshan Sansthan',
          type: 'Halp-Time',
          startDate: 'JUNE 2020',
          location: 'Sawai Madhopur, India',
          description: 'As a School Online Systems Manager at Bright Sun School Sawai Madhopur, I played a vital  in managing and optimizing the school\'s online systems, with a particular focus on student admissions and overseeing various aspects of online school sites. During my tenure, I successfully implemented efficient processes and ensured smooth operations within the school\'s digital infrastructure.',
        },
        {
          schoolName: 'Shubham Sr. Sec. School',
          type: 'Few-Time',
          startDate: 'JUNE 2020',
          location: 'Sawai Madhopur, India',
          description: 'As an Online Site Support Specialist, my primary focus is on ensuring the seamless operation and resolving technical issues related to online school sites. With a specialization in supporting sites associated with the Right to Education (RTE) and Board of Secondary Education (BSER), I am dedicated to delivering exceptional online experiences for students, teachers, and administrators..',
        },
      ];
      const works = [
        {
    ...
    <section id='about' className="bg-slate-900 py-10">
      ...
      <div className="px-4">
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="md:w-1/2 bg-slate-800 p-3 rounded-lg shadow-sm backdrop-brightness-200 backdrop-blur-sm">
  ...
  {experiences.map((experience, index) => (
    ...
    whileInView={{ opacity: 1, x: 0 }} key={index} className='bg-slate-800 m-3 p-3 rounded-md shadow-lg'>
      <h1 className='text-white'>{experience.schoolName}</h1>
...
<div id='work'>
  ...
  <div className='flex flex-wrap justify-center items-center'>
    {works.map((work, index) => (
      <motion.div initial={{ opacity: 0, x: -50 }} whileHover={{y: -10}} whileTap={{y: 10}}
      whileInView={{ opacity: 1, x: 0 }} key={index} className='works bg-slate-800 m-3 p-3 rounded-md shadow-lg w-96 relative'>
        <div className='flex items-center'>
          <h1 className='text-white text-xl mr-10 font-bold'>{work.projectName}</h1>
          <div className='absolute right-6 flex space-x-3'>
            {work.github && (
              <Link target="_blank" href={work.github}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" role="img" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="transition-all hover:stroke-cyan-300 hover:stroke-2 hover:-translate-y-2">
                  <title>GitHub</title>
        ...
        <p className='text-gray-500 w-50 mb-6'>{work.disc}</p>
        <span className='text-gray-300 space-x-4'>{work.language.split(',')}</span>
      </motion.div>
    ))}
  </div>
</div>
...
<div className="flex space-x-2 justify-center items-center p-5">
  <Link href={'https://github.com/LochanJangid'} className='pointer transition-all hover:scale-75' target='_blank'><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" width='50' height='50' stroke="#67e8f9" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="feather feather-github"><title>GitHub</title><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg></Link>
  <Link href={'https://www.linkedin.com/in/lochan-jangid-9a1073271/'} className='pointer transition-all hover:scale-75' target='_blank'><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" width='50' height='50' stroke="#67e8f9" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="feather feather-linkedin"><title>LinkedIn</title><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg></Link>
  <Link href={'mailto:lochanjangidcoder@gmail.com'} className='pointer transition-all hover:scale-75' target='_blank'><Image src={'/mail.png'} width={50} height={50} /></Link>
</div>
</div>
  </div>
    </div>
